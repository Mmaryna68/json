// Получаем данные о супергероях из JSON
document.addEventListener("DOMContentLoaded", function () {
  ...
  function createHeroCard(hero) {
    ...
    // Добавляем секцию рейтинга в карточку rating
    ...
    button.textContent = "CLICK"; //создаеи надпись внутри кнопки
